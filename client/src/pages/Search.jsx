  ...
  return (
    <div className='flex flex-col md:flex-row'>
        ...
        <div className='flex-1'>
            <h1 className='text-3xl font-semi-bold border-b p-3
            text-slate-700'>Listing results:</h1>
            <div className='p-7 flex flex-wrap gap-4'>
                {!loading && listings.length === 0 && (
                    <p className='text-xal text-slate-700'>No listing found!</p>
                )
                }

                {loading && (
                    <p className='text-xl text-slate-700 text-center width-full'>
                        Loading...</p>
                )}
